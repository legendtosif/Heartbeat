...
BOT_USERNAME = getenv("BOT_USERNAME" , "HeartbeatxMusicBot")
BOT_NAME = getenv("BOT_NAME" , "HEARTBEAT")
ASSUSERNAME = getenv("ASSUSERNAME" , "SUCHIASSISTANT")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/legendtosif/Heartbeat",)
