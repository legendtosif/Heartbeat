...
@app.on_message(filters.command(["getlog", "logs", "getlogs"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.user(7520092354))
@language
...
@app.on_message(filters.command(["update", "gitpull"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]) & filters.user(7520092354))
@language
...
@app.on_message(filters.command(["restart"]) & filters.user(7520092354))
